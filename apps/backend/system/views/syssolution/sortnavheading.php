            ...
            <div class="portlet light bordered">
                <div class="portlet-body">
                    <div class="dd" id="nestable_list_2" style="height:330px; overflow:auto">
                        <ol class="dd-list">
							<? foreach ($arrHeading as $heading) { ?>
                            <li class="dd-item" data-id="<?=$heading->ID?>">
                                <div class="dd-handle"> <?=$heading->sName?> </div>
                            </li>
                            <? } ?>
                        </ol>
                    </div>
...
function ok()
{
	...
	$.post(
		sHomeUrl+'/system/syssolution/sortnavheadingsave?SolutionID=<?=$_GET['SolutionID']?>',
