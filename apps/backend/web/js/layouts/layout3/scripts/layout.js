...
var Layout = function () {
    ...
    var handleHeader = function () {        
        ...
        // handle scrolling to top on responsive menu toggler click when header is fixed for mobile views
    ...
    return {
        ...
        closeMainMenu: function() {
            ...
            if (App.getViewPort().width < resBreakpointMd && $('.page-header-menu').is(":visible")) { // close the menu on mobile views while laoding a page 
