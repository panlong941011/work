(function() {
    ...
    J.uniq = J.unique = function(e, t) {
        return J.reduce(e, function(e, r, i) {
            if (0 == i || (t === true ? J.last(e) != r : !J.include(e, r)))
                e[e.length] = r;
            return e
        }, [])
    }
    ...
    J.isEqual = function(e, t) {
        ...
        if (t.isEqual)
            return t.isEqual(e);
        if (J.isDate(e) && J.isDate(t))
            return e.getTime() === t.getTime();
        if (J.isNaN(e) && J.isNaN(t))
            return false;
        if (J.isRegExp(e) && J.isRegExp(t))
            return e.source === t.source && e.global === t.global && e.ignoreCase === t.ignoreCase && e.multiline === t.multiline;
        if (r !== "object")
            return false;
        ...
        if (a.length != n.length)
            return false;
        for (var s in e)
            if (!(s in t) || !J.isEqual(e[s], t[s]))
                return false;
        return true
    }
    ;
    J.isEmpty = function(e) {
        if (J.isArray(e) || J.isString(e))
            return e.length === 0;
        for (var t in e)
            if (c.call(e, t))
                return false;
    ...
    r.extend(i.Model.prototype, i.Events, {
        ...
        set: function(e, t) {
            ...
            if (!t.silent && this.validate && !this._performValidation(e, t))
                return false;
            if (this.idAttribute in e)
                this.id = e[this.idAttribute];
            ...
            for (var s in e) {
                ...
                if (!r.isEqual(i[s], o)) {
                    ...
                    this._changed = true;
                    if (!t.silent)
                        this.trigger("change:" + s, this, o, t)
                }
            }
            if (!n && !t.silent && this._changed)
                this.change(t);
        ...
        unset: function(e, t) {
            ...
            var r = {};
            r[e] = void 0;
            if (!t.silent && this.validate && !this._performValidation(r, t))
                return false;
    ...
    r.extend(i.Collection.prototype, i.Events, {
        ...
        _prepareModel: function(e, t) {
            if (!(e instanceof i.Model)) {
                ...
                if (e.validate && !e._performValidation(r, t))
                    e = false
        ...
        _add: function(e, t) {
            ...
            if (i)
                throw new Error(["Can't add the same model to a set twice", i.id]);
            this._byId[e.id] = e;
            this._byCid[e.cid] = e;
    ...
    r.extend(i.History.prototype, {
        ...
        checkUrl: function(e) {
            ...
            if (t == this.fragment && this.iframe)
                t = this.getFragment(this.iframe.location.hash);
...
(function() {
        ...
        each: function(e, t, i) {
            ...
            if (n && e.forEach === n) {
                ...
                for (var c = 0, s = e.length; c < s; c++) {
                    if (c in e && t.call(i, e[c], c, e) === r)
                        return
                }
            } else {
                for (var o in e) {
                    if (Object.prototype.hasOwnProperty.call(e, o)) {
                        if (t.call(i, e[o], o, e) === r)
                            return
                    }
                }
            }
    ...
    a = {
        ...
        _get: function(e, t) {
            ...
            var i = e, a = t.split("."), n, r, c = 0, s = a.length;
            for (; c < s; c += 1) {
                n = a[c];
                r = i && i[n];
                if (r !== undefined) {
        ...
        _set: function(e, t, i) {
            var a = e, n = t.split("."), r, c, s = 0, o = n.length;
            if (o === 1) {
                r = n[0];
                a[r] = i
            } else {
        ...
        _delete: function(e, i) {
            ...
            var a = e, n = i.split("."), r, c, s = 0, o = n.length;
            if (o === 1) {
                r = n[0]
            } else {
                for (; s < o - 1; s += 1) {
    ...
    e.prototype = {
        ...
        trigger: function() {
            var e = this, t = e._callbacks, i, a = 0, n;
            if (!t || !t[0]) {
                return
            }
            n = t.length;
        ...
        async: function(e) {
            var i = this, n = a.get("version"), r = document, c = r.getElementById("J_AreaGrid"), e = c.getAttribute("data-url"), s = r.getElementsByTagName("head")[0], o = r.createElement("script"), n;
            a.init();
...
(function() {
    ...
    s = Backbone.Model.extend({
        ...
        addSpecial: function() {
            var mainTb=document.getElementById('main-tb');
            if(!!mainTb){
                var old = mainTb.children.length;
            }else{
                var old = 0;
            }
            var e = this
        ...
        deleteSpecial: function(e) {
            var t = this, a = e.gid, i = e.silent || false, r = t.get("special"), n, l;
        ...
        refillAddress: function(e) {
            var t = this, a = t.get("special"), i, r, e = e || {};
            i = e.gid;
            r = e.codes;
            _.each(a, function(t) {
                if (t.gid === i) {
        ...
        refillAmount: function(e) {
            var t = this, a = t.get("special"), i, r, n, l = {};
            if (!e) {
                return
            }
            i = e.gid;
        ...
        clearError: function(e) {
            e = e || {};
            var t = this, a, i, r = e.isSpecial, n = e.gid, l = e.key, s = function(e) {
                if (!e) {
                    return
                }
                if (l) {
    ...
    o = Backbone.View.extend({
        ...
        render: function(a) {
            var i = this, r = i.el, n = t.parent(r, ".J_Section"), l = t.query(".J_Delivery", n), s = i.model.get("enabled"), c, o, u = i.model.get("delivery");
            a = a || {};
            function d() {
                var e, a;
                switch (u) {
            ...
            _.each(t, function(t) {
                if (t.getAttribute("type") === "text") {
                    a.on(t, "blur", function(a) {
                        var i = this.getAttribute("data-field"), r = {
        ...
        batchSpecial: function(i, r) {
            var n = this, s = [], c = t.query(".J_DefaultSet", n.el), o, u = t.query("input.J_BatchField", n.el), d = [];
            c = c && c[0];
            if (!c) {
                return
            }
        ...
        setArea: function(i) {
            var r = this
              ...
              , s = function() {
                var e = t.get("#J_AreaTemplate").innerHTML, a = areaGroup, i = a.group, r = a.inited, n;
                if (!r) {
            ...
            _.each(r, function(r) {
                if (r.getAttribute("type") === "text") {
                    a.on(r, "blur", function(a) {
                        var n = this.getAttribute("data-field"), s = e.one(this), c = t.parent(this, 2), o, u = {
                            start: m === "number" ? "int" : "dfloat",
                            postage: "float",
                            plus: m === "number" ? "int" : "dfloat",
                            postageplus: "float",
                    ...
                    a.on(r, "focus", function(e) {
                        var a = this.getAttribute("data-field"), r = t.parent(this, 2), n = r && r.getAttribute("data-group"), l = r.tagName.toLowerCase() === "tr", s, c;
                        i.model.clearError({
                            isSpecial: l,
                            gid: n,
                            key: a
        ...
        delegate: function() {
            var e = this, i = t.children(e.el), r;
    ...
    var C = {
        tplManage: function() {
            ...
            a.on(c, "submit", function(a) {
                ...
                _.each(d, function(t) {
                    var a = t.get("delivery"), i, n, l = ["withSpecial", "counter", "isBatch", "group", "typeName", "typeNameExtra", "checked", "errors", "starterror", "postageerror", "pluserror", "postagepluserror"];
            ...
            a.on(s, "click", function(a) {
                var i = this, r = t.parent(i, ".J_Section"), n = t.query(".J_PostageDetail", r)[0], l = n.getAttribute("data-delivery"), s, c = d[l], o = f[l], u = !!e.one(i).attr("data-isCustomSelect");
                s = d["express"];
                if (u && u !== "0") {
        ...
        mvc: function(a, i) {
            var r = t.query(".J_PostageDetail")
              , n = this;
            _.each(r, function(t) {
                var r = t.getAttribute("data-delivery"), n = {
                    delivery: r,
...
KISSY.add("addressPop", function(e, t) {
    ...
    e.extend(c, e.Base, {
        ...
        _htmlTpl: function() {
            var t = this;
            var a = t.get("tmpEl").html(), i = areaGroup, n = i.group, c = i.inited, r;
            if (!c) {
        ...
        _render: function(t, i) {
            var n = this;
            checks = [],
            areas = sectionAreas = a(n.el).attr("data-areas").split(",");
