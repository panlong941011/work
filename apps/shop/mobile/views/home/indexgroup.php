...
<?php $this->endBlock() ?>
    ...
    <div class="index_wrap">
        ...
        <div class="recommend_content">
            <div class="cat_title" style="text-align: center;width: 100%;border-bottom: 1px solid #ddd;margin-left:0;">今日必团</div>
            <ul id="hot_sale" class="slide-box">
                <?foreach ($arrRecommed as $recommend){?>
                <li class="slide-item">
                    <a href="<?= $recommend['link'] ?>">
                        <img class="product_image" src="<?= $recommend['image'] ?>">
                        <span class="product_title"><?= $recommend['title'] ?></span>
                        <span class="product_price"><?= $recommend['price'] ?></span> </a>
                </li>
                <?}?>
            </ul>
        </div>
