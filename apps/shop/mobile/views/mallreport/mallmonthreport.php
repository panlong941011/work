    ...
    <div class="content">
        <div class="con-nav">
            <ul>
                ...
                <li>
                    <a href="<?= \Yii::$app->request->shopRootUrl ?>/mallreport/mallweekreport">周报表</a>
                </li>
                <li class="cur">
        ...
        <div class="btns">
            <a href="<?= \Yii::$app->request->shopRootUrl ?>/mallreport/mallmonthreport?dDate=<?= $dLastDate ?>"><< 上个月</a>
			<? if ($bToday) { ?>
                <a href="javascript:;" style="background-color: #EEE">下个月 >></a>
			<? } else { ?>
                <a href="<?= \Yii::$app->request->shopRootUrl ?>/mallreport/mallmonthreport?dDate=<?= $dNextDate ?>">下个月 >></a>
			<? } ?>
        </div>
    </div>
