...
<div class="content">
    ...
    <div class="btns">
        <a href="<?= \Yii::$app->request->shopRootUrl ?>/mallreport/malldayreport?dDate=<?= $dLastDate ?>"><< 前一天</a>
		<? if ($bToday) { ?>
            <a href="javascript:;" style="background-color: #EEE">后一天 >></a>
		<? } else { ?>
            <a href="<?= \Yii::$app->request->shopRootUrl ?>/mallreport/malldayreport?dDate=<?= $dNextDate ?>">后一天 >></a>
		<? } ?>
    </div>
</div>
