                            ...
                            <li v-for="item in dataList">
                                <a :href="item.link" class="flex">
                                    ...
                                    <div class="list_content flexOne">
                                        ...
                                        <span v-text="'已售'+item.sold+'件'" class="seller"></span>
                                        <span v-text="'经销商：'+item.sSeller" class="wholesaleCostPrice"></span>
                                        <span v-if ='item.wholesaleCostPrice' v-text="'供货价：'+item.wholesaleCostPrice" class="wholesalePrice"></span>
                                        <span v-text="'渠道价：'+item.wholesalePrice" class="wholesalesold"></span>
                                    </div>
                                </a>
                            </li>
                        </ul>
                ...
                <div class="hot_content">
					<? foreach ($arrHotSearchWord as $item) { ?>
                        <span onclick="location.href='<?= \yii\helpers\Url::toRoute([
							\Yii::$app->request->shopUrl . "/wholesaler/product",
							'keyword' => $item['sName']
        ...
        new Vue({
            ...
            methods: {
                ...
                getData: function (mark) {
                    ...
                    $.ajax({
                        type: 'GET',
                        url: '<?=\yii\helpers\Url::toRoute([\Yii::$app->request->shopUrl . "/wholesaler/productlist"], true)?>',
                        data: _this.reqData,
                        dataType: 'json',
