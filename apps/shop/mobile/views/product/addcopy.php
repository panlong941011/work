    ...
    <div class="refund_apply" id="app" v-cloak>
        ...
        <section>
            ...
            <div class="apply_item flex" id="J_ShowActionSheet" @click="selectShow('reason')">
                <div class="item_title">商品类型：</div>
                <div class="item_content" v-text="productCat"></div>
            </div>
            <div class="apply_price flex">
    ...
    <script>
        new Vue({
            ...
            methods: {
                ...
                init: function () {
                    //初始化区域
                    var len0 = this.arrCat.length;
                    for (var j = 0; j < len0; j++) {
                        this.reasonData.data.push({'isMark': false, 'name': this.arrCat[j].sName});
                    }
                    ...
                    //类型初始化
                    var len = this.arrArea.data.length;
                    console.log(this.arrArea.data.length);
                    for (var j = 0; j < len; j++) {
                        if (this.arrArea.data[j].name == this.area) {
                            this.arrArea.data[j].isMark = true;
                        }
                    }
                    ...
                    for (var k = 0; k < len2; k++) {
                        if (this.reasonData.data[k].name == this.productCat) {
                            this.reasonData.data[k].isMark = true;
                        }
                    }
                ...
                submitData: function () {
                    ...
                    if (_this.productCat == "请选择商品类型") {
                        shoperm.showTip('请选择商品类型');
                        return;
                    }
                    ...
                    $.post('/product/add',data, function (data) {
                            if (data.status) {
