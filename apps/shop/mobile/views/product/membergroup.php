...
<?php $this->endBlock() ?>
    <header class="header flex">
        ...
        <div class="person_name_wrap">
            ...
            <h3 class="person_title">手机：<?= $groupaddress->sMobile ?></h3>
    ...
    <script>
        ...
        function promotionToEnd(nowTime, endTime) {
            var t = setInterval(function () {
                ...
                $('#promotionDate').html('距结束：<span>' + hours + '</span> : <span>' + minutes + '</span> : <span>' + seconds + '</span> ');
            }, 1000);
        }
