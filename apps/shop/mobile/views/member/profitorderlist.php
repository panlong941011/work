                    ...
                    <section class="list_layer" v-for="item in dataList">
                                ...
                                <div class="list_item flex">
                                    ...
                                    <div class="info">
                                        ...
                                        <div class="price flex">
                                            <em v-text="'￥'+goods.price"></em><i class="num" v-text="'X'+goods.num"></i>
                                        </div>
                                        <h4 class="title multiEllipsis" v-text="item.memberName"></h4>
                                        <h4 class="title multiEllipsis" v-text="item.seller"></h4>
                        ...
                        <div class="list_footer">
                            <div class="total layer flex">
                                <div class="all_product" v-text="item.profit"></div>
