...
<div class="distribution">
    ...
    <div class="income">
        ...
        <ul class="income_item flex">
            ...
            <li>
                <a href="/seller/flow">
                    <em><?= number_format($seller->fUnsettlement + $seller->fSettlement+$seller->fWithdrawed, 2) ?></em>
                    <span>累计收入</span>
                </a>
            </li>
        </ul>
