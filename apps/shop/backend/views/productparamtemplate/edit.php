<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption">
            <span class="caption-subject font-green-haze bold uppercase">编辑 参数模板</span>
            ...
            <div class="portlet light bordered">
                ...
                <div name="基本信息">
                    ...
                    <div class="portlet-body form margin-top-10">
                        <form name="objectform" action="/shop/productparamtemplate/editsave" class="horizontal-form"
