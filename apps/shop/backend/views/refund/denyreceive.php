    ...
    <form name="applyform">
            <div class="row">
                ...
                <div class="col-md-12 margin-top-20">
                    ...
                    <div class="col-md-8">
                        <textarea rows="4" name="sDenyReceiveExplain" class="form-control" placeholder="您可以告诉买家您拒绝的详细原因和下一步如何操作，以便买家处理最多150字"></textarea>
                    </div>
                </div>
            </div>
    </form>
...
<script>
    ...
    function ok() {
        ...
        $.post(
            '/shop/refund/denyreceive?ID=<?=$_GET['ID']?>',
