        ...
        <div class="portlet light bordered">
            <div class="portlet-body form">
                <form name="objectform" class="horizontal-form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                        <h3 class="form-section">导入渠道订单</h3>
                        <img src="/img/preorder.jpg">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label col-md-12">上传Excel文件*:</label>
                                    <div class="col-md-12 upfile">
                        ...
                        <p style="margin:10px 0 0 15px">
                            ...
                            <span class="help-block">① 请先下载空白模板文件  <a href="<?=Yii::$app->homeUrl?>/userfile/empty.xlsx" download="">点击下载空白模板文件</a></span>
                            <span class="help-block">② 填写完整空白模板文件中所需的商品名称、数量等字段后将文件上传即可</span>
                            <span class="help-block">③点击“选择文件”，可选择订单Excel，如选错可重新点击</span>
                        </p>
