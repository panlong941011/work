    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form margin-top-10">
                <form name="objectform" action="/shop/shipaddress/edit"
                                    ...
                                    <div class="col-md-9">
                                        <select name="ClearingWayID">
                                            ...
                                            <option value="new_clearing"
                                                <? if ($ShipAddressInfo['ClearingWayID'] == "new_clearing") { ?>
                                                    selected
                                                <? } ?>
                                            >现结
                                            </option>
                                            <option value="to_pay"
                                                <? if ($ShipAddressInfo['ClearingWayID'] == "to_pay") { ?>
                                                    selected
                                                <? } ?>
                                            >到付</option>
                                            <option value="monthly_clearing"
                                                <? if ($ShipAddressInfo['ClearingWayID'] == "monthly_clearing") { ?>
                                                    selected
                                                <? } ?>
                                            >月结</option>
                                            <option value="third_party_payment"
                                                <? if ($ShipAddressInfo['ClearingWayID'] == "third_party_payment") { ?>
                                                    selected
                                                <? } ?>
                                            >第三方支付</option>
                                        </select>
