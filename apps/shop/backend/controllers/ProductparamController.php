...
use myerm\shop\common\models\ProductParamValue;
 ...
 * @version v1.0
 */
class ProductparamController extends ObjectController
{
    public function afterDel($arrData)
    {
        foreach ($arrData as $data) {
            ProductParamValue::deleteAll(['ProductParamID' => $data['lID']]);
        }
