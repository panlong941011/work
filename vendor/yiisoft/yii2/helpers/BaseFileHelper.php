...
class BaseFileHelper
{
     ...
     *   For example, `views/*.php` matches `views/home.php` but not `views/controller/home.php`.
     *   A leading slash matches the beginning of the pathname. For example, `/*.php` matches `home.php` but not `views/start/home.php`.
