 ...
 *
 *  * `appPath` - full path to the application, include home.php</li>
 *  * `url` - full url to the home.php entry script</li>
 *
 * In your home.php you must return an array with correct configuration for the application:
 *
 * For the simple created yii application home.php will be like this:
 *
 * ```php
 * <?php
